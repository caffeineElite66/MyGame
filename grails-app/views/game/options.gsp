<html>
  <head>
    ...
    <!-- required javascripts and css from jquery -->
  ...
  <!-- custom jquery javascript for creating buttonsets -->
  ...
  <!-- custom css for the buttons on this page only -->
  <style type="text/css">
    #options .ui-button {
      width: 200px;
      font-size: 25px;
...
<!-- Form for selecting user options -->
